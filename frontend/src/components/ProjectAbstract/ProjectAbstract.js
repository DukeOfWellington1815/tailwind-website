...
export default function ProjectAbstract() {
  ...
  const projectGithub = {
    "BadiBuddy": "https://github.com/TD99/badibuddy",
  };
              ...
              <div className={`flex flex-col items-center mx-4 md:mx-64 mt-4 md:mt-10 content ${isVisible ? 'visible' : ''}`}>
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:flex-2/3 max-w-full md:max-w-4xl md:ml-16">
                    ...
                    <div className={`flex items-center justify-start md:justify-end mt-4 ${isVisible ? 'fade-in visible' : ''}`}>
                    {githubForProject && (
                        <a
                          href={githubForProject}
                          target="new"
                          className={`uppercase secondary-color font-semibold text-2xl  py-2 rounded-md hover:opacity-80 ${isVisible ? 'fade-in visible' : ''}`}
                        >
                          Github
                        </a>
                      )}
