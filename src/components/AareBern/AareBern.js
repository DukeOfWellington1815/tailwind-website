    ...
    <div className="Aare">
      {temp.aare && temp.aare.location && (
        <div className='gameDiv grid gap-4 grid-cols-1 sm:grid-cols-2 p-10'>
          <article className='aare-box-temperatur container mx-auto rounded-xl shadow-lg p-8'>
          ...
          <article className='aare-box-temperatur container mx-auto rounded-xl shadow-xl p-8'>
